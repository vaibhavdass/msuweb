<?php
require_once 'Mage/Usa/Model/Shipping/Carrier/Dhl/International.php';
class Naresh_Custom_Model_Shipping_Carrier_Dhl_International extends Mage_Usa_Model_Shipping_Carrier_Dhl_International
{
    /**
    ...
    protected function _doRequest()
    {
        ...
        $DutyPaymentType = 'R';
        if ($rawRequest->getOrderShipment()->getOrder()->getFeeAmount() > 0 || $rawRequest->getRecipientAddressCountryCode() == 'US' || $rawRequest->getRecipientAddressCountryCode() == 'HK') {
            $DutyPaymentType = 'S';
        }
        ...
        $nodeConsignee->addChild('DivisionCode', $rawRequest->getRecipientAddressStateOrProvinceCode());
        ...
        $nodeShipper->addChild('DivisionCode', $rawRequest->getShipperAddressStateOrProvinceCode());
