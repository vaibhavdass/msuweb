 ...
 */
class LitExtension_CartMigration_Model_Cart_Magento14 extends LitExtension_CartMigration_Model_Cart {
...
//            }
    ...
    public function afterSaveOrder($order_mage_id, $data, $order, $ordersExt) {
        ...
        foreach ($orderHistory as $key => $row) {
            ...
            $order_status_data['status'] = $this->_notice['config']['order_status'][$row['status']];
    ...
    protected function _importChildrenConfigurableProduct($parent, $children, $productsExt) {
        ...
        foreach ($attributeIds as $row) {
            ...
            foreach ($children as $child) {
                ...
                if (!$attr_after) {
                    var_dump($attr_import['config']);exit();
                    return false;
                }
