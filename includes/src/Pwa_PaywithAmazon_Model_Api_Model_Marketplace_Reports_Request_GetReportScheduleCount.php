...
/**
 * Amazon Marketplace Reports API: GetReportScheduleCount request model
 *
 * Fields:
 * <ul>
...
*/
class Pwa_PaywithAmazon_Model_Api_Model_Marketplace_Reports_Request_GetReportScheduleCount extends Pwa_PaywithAmazon_Model_Api_Model_Marketplace_Reports_Abstract {
    ...
    public function convertToQueryString() {
        $params = array();
        $params['Action'] = 'GetReportScheduleCount';
