<?php 
	echo "<table id=modulename_tbl_data>
       <tbody>
            <tr id=tr1 class=tr_measurementremember>
                <th>Price From</th>
                <th>Price To</th>
				<th>Choose Type</th>
                <th>Percentage</th>
            </tr>
            <tr id=tr2 class=tr_measurementremember>
...
<script>
		$('.add').click(function() { 
			...
			var tr = '<tr class="tr_measurementremember"  id="tr'+j+'"><td id="'+(i-1)+'"">'+one+'</td><td id="'+i+'">'+one+'</td><td id="'+(i+1)+'"">'+dropdown+'</td><td id="'+(i+2)+'"">'+one+'</td><td>'+remove+'</td></tr>';  
