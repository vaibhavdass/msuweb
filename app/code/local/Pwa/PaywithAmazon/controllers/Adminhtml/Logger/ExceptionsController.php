 ...
 */
class Pwa_PaywithAmazon_Adminhtml_Logger_ExceptionsController extends Mage_Adminhtml_Controller_Action {

    protected function _getModel() {
        return Mage::getModel('paywithamazon/log_exception');
    }

    protected function _initAction() {
        $this->loadLayout()->_setActiveMenu('creativestyle/paywithamazon/logger/exceptions');
        return $this;
    }
    ...
    protected function _setTitle($title = null) {
        $this->_title(Mage::helper('paywithamazon')->__('Checkout by Amazon'))
            ->_title(Mage::helper('paywithamazon')->__('Amazon exceptions'));
    ...
    public function viewAction() {
        ...
        if ($logModel->getId()) {
            ...
            $this->_addContent($this->getLayout()->createBlock('paywithamazon/adminhtml_logger_exceptions_view')->setLogModel($logModel));
            $this->renderLayout();
        } else {
