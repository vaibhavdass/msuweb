 ...
 */
class Pwa_PaywithAmazon_Adminhtml_Logger_FeedsController extends Mage_Adminhtml_Controller_Action {

    protected function _getModel() {
        return Mage::getModel('paywithamazon/log_feed');
    }

    protected function _initAction() {
        $this->loadLayout()->_setActiveMenu('creativestyle/paywithamazon/logger/feeds');
        return $this;
    }
    ...
    protected function _setTitle($title = null) {
        $this->_title(Mage::helper('paywithamazon')->__('Checkout by Amazon'))
            ->_title(Mage::helper('paywithamazon')->__('Amazon MWS Feeds'));
    ...
    public function viewAction() {
        ...
        if ($logModel->getId()) {
            ...
            $this->_addContent($this->getLayout()->createBlock('paywithamazon/adminhtml_logger_feeds_view')->setLogModel($logModel));
            $this->renderLayout();
        } else {
