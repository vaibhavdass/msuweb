...
/**
 * Amazon Marketplace Reports API: CancelReportRequests request model
 *
 * Fields:
 * <ul>
...
*/
class Pwa_PaywithAmazon_Model_Api_Model_Marketplace_Reports_Request_CancelReportRequests extends Pwa_PaywithAmazon_Model_Api_Model_Marketplace_Reports_Abstract {
    ...
    public function convertToQueryString() {
        $params = array();
        $params['Action'] = 'CancelReportRequests';
