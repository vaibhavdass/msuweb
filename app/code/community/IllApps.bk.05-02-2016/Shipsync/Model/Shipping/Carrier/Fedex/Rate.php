...
class IllApps_Shipsync_Model_Shipping_Carrier_Fedex_Rate extends IllApps_Shipsync_Model_Shipping_Carrier_Fedex
{
    ...
    public function getWsdlQuotes()
    {
        ...
        Mage::log($this->getData(),null,'fedex.log');
        $rateResult = Mage::getModel('shipping/rate_result');
        Mage::log('Rate Key : '.$this->getFedexKey());
        Mage::log('Rate Password : '.$this->getFedexPassword());
        Mage::log('Rate AccountNumber : '.$this->getFedexAccount());
        Mage::log('Rate MeterNumber : '.$this->getFedexMeter());
