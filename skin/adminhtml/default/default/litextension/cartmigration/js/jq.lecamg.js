            ...
            function importPages()
            {
                ...
                $.ajax({
                    ...
                    success: function(response, textStatus, jqXHR) {
                        ...
                        if(response.result === 'success'){
                            showProcessBar(settings.processPages, response.pages.total, response.pages.imported, response.pages.error, response.pages.point);
            ...
            function importBlocks()
            {
                ...
                $.ajax({
                    ...
                    success: function(response, textStatus, jqXHR) {
                        ...
                        if(response.result === 'success'){
                            showProcessBar(settings.processBlocks, response.blocks.total, response.blocks.imported, response.blocks.error, response.blocks.point);
            ...
            function importWidgets()
            {
                ...
                $.ajax({
                    ...
                    success: function(response, textStatus, jqXHR) {
                        ...
                        if(response.result === 'success'){
                            showProcessBar(settings.processWidgets, response.widgets.total, response.widgets.imported, response.widgets.error, response.widgets.point);
                            setTimeout(importWidgets, settings.timeDelay);
                        } else if(response.result === 'error'){
                            showConsoleLog(settings.msgTryWarning);
                            showTryAgainImport(settings.processWidgets);
            ...
            function importPolls()
            {
                ...
                $.ajax({
                    ...
                    success: function(response, textStatus, jqXHR) {
                        ...
                        if(response.result === 'success'){
                            showProcessBar(settings.processPolls, response.polls.total, response.polls.imported, response.polls.error, response.polls.point);
            ...
            function importTransactions()
            {
                ...
                $.ajax({
                    ...
                    success: function(response, textStatus, jqXHR) {
                        ...
                        if(response.result === 'success'){
                            showProcessBar(settings.processTransactions, response.transactions.total, response.transactions.imported, response.transactions.error, response.transactions.point);
            ...
            function importNewsletters()
            {
                ...
                $.ajax({
                    ...
                    success: function(response, textStatus, jqXHR) {
                        ...
                        if(response.result === 'success'){
                            showProcessBar(settings.processNewsletters, response.newsletters.total, response.newsletters.imported, response.newsletters.error, response.newsletters.point);
            ...
            function importUsers()
            {
                ...
                $.ajax({
                    ...
                    success: function(response, textStatus, jqXHR) {
                        ...
                        if(response.result === 'success'){
                            showProcessBar(settings.processUsers, response.users.total, response.users.imported, response.users.error, response.users.point);
            ...
            function importRoles()
            {
                ...
                $.ajax({
                    ...
                    success: function(response, textStatus, jqXHR) {
                        ...
                        if(response.result === 'success'){
                            showProcessBar(settings.processRoles, response.rules.total, response.rules.imported, response.rules.error, response.rules.point);
            ...
            function importCartrules() {
                ...
                $.ajax({
                    ...
                    success: function(response, textStatus, jqXHR) {
                        ...
                        if(response.result === 'success'){
                            showProcessBar(settings.processCartrules, response.cartrules.total, response.cartrules.imported, response.cartrules.error, response.cartrules.point);
                            $(settings.formImportSubmit).show();
                            deleteLecmCookie();
                        } else if(response.result === 'error'){
                            showConsoleLog(settings.msgTryWarning);
